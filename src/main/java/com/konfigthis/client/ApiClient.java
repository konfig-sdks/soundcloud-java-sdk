...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.soundcloud.com";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("AuthHeader", new ApiKeyAuth("header", "Authorization"));
        ...
        if (configuration != null) {
            if (configuration.authHeader != null) {
                this.setAuthHeader(configuration.authHeader);
            }
    ...
    public String getAuthHeader() {
        return ((ApiKeyAuth) this.getAuthentication("AuthHeader")).getApiKey();
    }

    public void setAuthHeader(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("AuthHeader")).setApiKey(apiKey);
    }

    public void setAuthHeaderPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("AuthHeader")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.soundcloud.com)
