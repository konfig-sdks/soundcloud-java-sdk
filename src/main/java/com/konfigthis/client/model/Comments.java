...
public class Comments {
  ...
  private List<Comment> collection = null;
  ...
  public Comments collection(List<Comment> collection) {
  ...
  public Comments addCollectionItem(Comment collectionItem) {
  ...
  **/
  ...
  public List<Comment> getCollection() {
    return collection;
  }


  public void setCollection(List<Comment> collection) {
  ...
  public Comments nextHref(String nextHref) {
  ...
  **/
   ...
   * @return the Comments instance itself
   */
  public Comments putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.collection, comments.collection) &&
        Objects.equals(this.nextHref, comments.nextHref)&&
        Objects.equals(this.additionalProperties, comments.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Comments
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Comments.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("collection") != null && !jsonObj.get("collection").isJsonNull()) {
        ...
        if (jsonArraycollection != null) {
          ...
          for (int i = 0; i < jsonArraycollection.size(); i++) {
            Comment.validateJsonObject(jsonArraycollection.get(i).getAsJsonObject());
          };
        }
      }
      if (!jsonObj.get("next_href").isJsonNull() && (jsonObj.get("next_href") != null && !jsonObj.get("next_href").isJsonNull()) && !jsonObj.get("next_href").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Comments>() {
           ...
           public Comments read(JsonReader in) throws IOException {
             ...
             Comments instance = thisAdapter.fromJsonTree(jsonObj);
