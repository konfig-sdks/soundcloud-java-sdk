...
public class Playlists {
  ...
  private List<Playlist> collection = null;
  ...
  public Playlists collection(List<Playlist> collection) {
  ...
  public Playlists addCollectionItem(Playlist collectionItem) {
  ...
  **/
  ...
  public void setCollection(List<Playlist> collection) {
  ...
  public Playlists nextHref(String nextHref) {
  ...
  **/
   ...
   * @return the Playlists instance itself
   */
  public Playlists putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.collection, playlists.collection) &&
        Objects.equals(this.nextHref, playlists.nextHref)&&
        Objects.equals(this.additionalProperties, playlists.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Playlists
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Playlists.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("collection") != null && !jsonObj.get("collection").isJsonNull()) {
        ...
        if (jsonArraycollection != null) {
          ...
          for (int i = 0; i < jsonArraycollection.size(); i++) {
            Playlist.validateJsonObject(jsonArraycollection.get(i).getAsJsonObject());
          };
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Playlists>() {
           ...
           public Playlists read(JsonReader in) throws IOException {
             ...
             Playlists instance = thisAdapter.fromJsonTree(jsonObj);
